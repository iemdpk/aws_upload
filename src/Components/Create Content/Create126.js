      ...
      <FlexColumn1>
        ...
        <FlexColumn2>
          <FlexRow4>
            ...
            <Eparrowdown
              src={"https://file.rendit.io/n/m6ZGBp5aTmG2KbHhWGd9.svg"}
            />
          ...
          <CadetBlueFlexColumn>
            ...
            <Image6 src={"https://file.rendit.io/n/rIwdawZqvbErY0HBoC4d.svg"} />
          </CadetBlueFlexColumn>
          <Image7 src={"https://file.rendit.io/n/9BLdqbiQjSSEfBQBdYJX.svg"} />
          <CadetBlueFlexColumn1>
            <Paragraph height={"212px"}>
              ...
              lorem scelerisque ut duis dignissim. Ut sapien platea non massa
              pretium, adipiscing ultrices. Nisl vel non urna eros lectus enim.
              Facilisis aliquet id non amet. Et luctus pulvinar eleifend
              gravida. Gravida risus tincidunt tellus, viverra nunc pharetra,
              lobortis.
              <br />
              <br />
              ...
              rhoncus maecenas quam et euismod. Semper pellentesque ipsut ornare
              egestas nisi, id volutpat ut nec. Sociis elit mattis integer nec
              lectus semper donec. Quis magna malesuada neque at tristique ut
              aliquet.{" "}
            </Paragraph>
            <Image6 src={"https://file.rendit.io/n/rIwdawZqvbErY0HBoC4d.svg"} />
          </CadetBlueFlexColumn1>
          ...
          <FlexColumn3>
            <CadetBlueFlexColumn2>
              <Text14>Type your Story....</Text14>
              <Image6
                src={"https://file.rendit.io/n/rIwdawZqvbErY0HBoC4d.svg"}
              />
            </CadetBlueFlexColumn2>
            <Image11
              src={"https://file.rendit.io/n/9BLdqbiQjSSEfBQBdYJX.svg"}
            />
...
const Element3 = styled.div`
  width: 317px;
  height: 46px;
  background-image: url("https://file.rendit.io/n/Rp4cepQ9smLTex8UOfN7.svg");
