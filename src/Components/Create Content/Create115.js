  ...
  return (
    <DesktopRoot>
      ...
      <FlexColumn1>
        <WhiteFlexColumn1>
          <WhiteFlexColumn2>
            <FlexRow2>
              <NeonCarrotFlexRow>
                <FlexRow3>
                  <Text2>Current Value</Text2>
                  <Text3>$12</Text3>
                </FlexRow3>
              </NeonCarrotFlexRow>
              <Search
                src={"https://file.rendit.io/n/AxutmjOoXczZPPPuyGir.svg"}
              />
              <Search
                src={"https://file.rendit.io/n/7L7LPRBYFUu3mkbKyLuz.svg"}
              />
              <FlexRow4>
                <UnsplashWFsNyI
                  src={"https://file.rendit.io/n/dJDNXRYEevvzbOSM3sjf.png"}
                />
                <Text4>Julia Michaels</Text4>
              </FlexRow4>
            </FlexRow2>
            <FlexColumn2>
              <Text5>Question Paper</Text5>
              <FlexRow5>
                <TotalQuestion>Total Question </TotalQuestion>
                <FlexColumn3>
                  <Text6>50</Text6>
                </FlexColumn3>
                <TotalQuestion>Grade</TotalQuestion>
                <FlexColumn3>
                  <Text6>08</Text6>
                </FlexColumn3>
                <TotalQuestion>Subject</TotalQuestion>
                <FlexRow6>
                  <Text10 width={"76px"}>Maths</Text10>
                </FlexRow6>
                <TotalQuestion>Topic</TotalQuestion>
                <FlexRow6>
                  <Text10 width={"76px"}>Algebra</Text10>
                </FlexRow6>
                <Text13>Tags</Text13>
                <NavyBlueText>#Lorem</NavyBlueText>
                <NavyBlueFlexRow>
                  <Text10 width={"64px"}>#Ipsum</Text10>
                </NavyBlueFlexRow>
                <Element27>
                  <Text15>Alignment</Text15>
                  <FlexRow8>
                    <Text10 width={"76px"}>ICSE</Text10>
                  </FlexRow8>
                </Element27>
              </FlexRow5>
              <FlexColumn5>
                <FlexRow9>
                  ...
                  <FlexColumn7 margin={"0px 8px 0px 0px"}>
                    <Text17>03</Text17>
                  </FlexColumn7>
                  <FlexColumn7 margin={"0px 8px 0px 0px"}>
                    <Text17>04</Text17>
                  ...
                  <FlexColumn7 margin={"0px 14px 0px 0px"}>
                    <Text17>23</Text17>
                  </FlexColumn7>
                  <Image1
                    src={"https://file.rendit.io/n/b1GBCP49ZMPe8ZZynyCZ.svg"}
                  />
                </FlexRow9>
                <FlexRow10>
                  <Element29>
                    <NavyBlueFlexRow1>
                      <Text40>Create on your Own</Text40>
                    </NavyBlueFlexRow1>
                    <Text41>Select from your previous Questions</Text41>
                  </Element29>
                  <Text42>Select from question bank</Text42>
                </FlexRow10>
              </FlexColumn5>
            </FlexColumn2>
          </WhiteFlexColumn2>
        ...
        <FlexColumn28>
          <FlexRow11 margin={"0px 0px 7px 0px"}>
            <Element30>
              <Paragraph top={"-134px"}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                porttitor vitae sed diam eu ut. Nunc bibendum sollicitudin
                egestas egestas nunc, et pulvinar in non. Tempor mollis
                tristique ultrices massa mi sit quam adipiscing?
              </Paragraph>
              <Element31 />
              <Text43 left={"-1010px"}>Option A</Text43>
              <Text44 top={"-114px"}>(or)</Text44>
              <Image5
                src={"https://file.rendit.io/n/mYMqtGtK0Hj31okm00f4.svg"}
                left={"-927px"}
              />
            </Element30>
            <CadetBlueFlexRow>
              <FlexRow4>
                <Image1
                  src={"https://file.rendit.io/n/FWJLTlSxUjaHSdY0sN0B.svg"}
                />
                <Text45 height={"32px"}>Add Image</Text45>
              </FlexRow4>
            </CadetBlueFlexRow>
          </FlexRow11>
          <FlexRow11 margin={"0px 0px 23px 0px"}>
            <Element32>
              <Paragraph top={"15px"}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.{" "}
              </Paragraph>
              <Element33 top={"0px"} />
              <Text44 top={"35px"}>(or)</Text44>
            </Element32>
            <CadetBlueFlexRow>
              <FlexRow4>
                <Image1
          ...
          <Element34>
            <Text43 left={"-15px"}>Option B</Text43>
            <Image5
              src={"https://file.rendit.io/n/qzslbDrU630hdByUpekO.svg"}
              left={"68px"}
            />
          </Element34>
          <FlexRow11 margin={"0px 0px 23px 0px"}>
          ...
          <Element37>
            <Text43 left={"-15px"}>Option C</Text43>
            <Image5
              src={"https://file.rendit.io/n/qzslbDrU630hdByUpekO.svg"}
              left={"68px"}
            />
          ...
          <FlexRow17>
            <Element38>
              ...
              <Text52>(or)</Text52>
              <Element33 top={"162px"} />
              <Text53>Option D</Text53>
              <Text44 top={"197px"}>(or)</Text44>
              <Image8 src={""} />
              <NavyBlueFlexColumn>
                <Text55>Save</Text55>
              </NavyBlueFlexColumn>
            ...
            <Element41>
              <CadetBlueFlexRow3>
                <FlexRow4>
                  <Add3
                    src={"https://file.rendit.io/n/NxLFt0yPzAwokEmd5LBc.svg"}
                  />
                  <Text45 height={"12px"}>Add Image</Text45>
                </FlexRow4>
              </CadetBlueFlexRow3>
              <CadetBlueFlexRow4>
                <FlexRow4>
...
const WhiteFlexColumn = styled.div`
  ...
  padding: 48px 12px;
`;
const Icoutlinearticle = styled.img`
  width: 24px;
  height: 24px;
...
const NavyBlueText = styled.div`
  ...
  width: 67px;
  height: 25px;
  background-color: rgba(20, 169, 255, 0.05);
  flex-direction: column;
  border-radius: 4px;
...
const CadetBlueFlexRow3 = styled.div`
  box-shadow: 0px 2px 2px 0px rgba(22, 22, 22, 0.08);
  width: 166px;
